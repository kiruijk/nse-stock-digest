...
const BOOK_VALUES_FILE = 'data/book-values.json';
...
function readBookValues() {
  return fs.existsSync(BOOK_VALUES_FILE) ? JSON.parse(fs.readFileSync(BOOK_VALUES_FILE, 'utf8')) : {};
}
...
function withDetails(stock, bookValues = {}) {
...
function render(data) {
  ...
  const bookValues = readBookValues();
  const stocks = Object.fromEntries(Object.entries(data.stocks).map(([s, d]) => [s, withDetails(d, bookValues)]));
